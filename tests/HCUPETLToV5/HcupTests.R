...
add_core(key = "4200000000101", age = 20)
expect_person(person_id = personIdPlusPlus(), person_source_value = "4200000000101")

declareTest(102, "Person gender mappings")
add_core(key = "4200000000102", female = 0, age = 20)
add_core(key = "4200000000103", female = 1, age = 20)
add_core(key = "4200000000104", female = 9, age = 20)
...
add_core(key = "4200000000105", age = 20, year = 2010)
...
add_core(key = "4200000000108", age = 20, race = 1)
add_core(key = "4200000000109", age = 20, race = 2)
add_core(key = "4200000000110", age = 20, race = 3)
add_core(key = "4200000000111", age = 20, race = 4)
add_core(key = "4200000000112", age = 20, race = 5)
add_core(key = "4200000000113", age = 20, race = 6)
add_core(key = "4200000000114", age = 20, race = -9)
add_core(key = "4200000000115", age = 20, race = -8)
...
add_core(key = "4200000000203", age = 20, year = 2010, amonth = 2, aweekend = 0) # 1st of Feb 2010 is a Monday
expect_visit_occurrence(person_id = personIdPlusPlus(), visit_start_date = "2010-02-01")
add_core(key = "4200000000204", age = 20, year = 2010, amonth = 2, aweekend = 1) # 6st of Feb 2010 is a Saturday
expect_visit_occurrence(person_id = personIdPlusPlus(), visit_start_date = "2010-02-06")
add_core(key = "4200000000205", age = 20, year = 2010, amonth = 2, aweekend = -9) # 1st of Feb 2010 is a Saturday
expect_visit_occurrence(person_id = personIdPlusPlus(), visit_start_date = "2010-02-01")

declareTest(204, "Visit end date")
add_core(key = "4200000000206", age = 20, year = 2010, amonth = 2, aweekend = 0, los = 0) # 1st of Feb 2010 is a Monday
expect_visit_occurrence(person_id = personIdPlusPlus(), visit_end_date = "2010-02-01")
add_core(key = "4200000000207", age = 20, year = 2010, amonth = 2, aweekend = 0, los = 2) # 1st of Feb 2010 is a Monday
expect_visit_occurrence(person_id = personIdPlusPlus(), visit_end_date = "2010-02-03")
add_core(key = "4200000000208", age = 20, year = 2010, amonth = 2, aweekend = 0, los = -9) # 1st of Feb 2010 is a Monday
expect_visit_occurrence(person_id = personIdPlusPlus(), visit_end_date = "2010-02-01")

declareTest(205, "Visit type concept ID")
add_core(key = "4200000000209", age = 20)
expect_visit_occurrence(person_id = personIdPlusPlus(), visit_type_concept_id = 44818517)

declareTest(206, "Visit care site")
add_core(key = "4200000000210", age = 20, hospid = 12345)
...
add_core(key = "4200000000301", age = 20)
expect_observation_period(person_id = personIdPlusPlus())

declareTest(302, "Observation period start date")
add_core(key = "4200000000302", age = 20, year = 2010, amonth = 2, aweekend = 0) # 1st of Feb 2010 is a Monday
expect_observation_period(person_id = personIdPlusPlus(), observation_period_start_date = "2010-02-01")
add_core(key = "4200000000303", age = 20, year = 2010, amonth = 2, aweekend = 1) # 6st of Feb 2010 is a Saturday
expect_observation_period(person_id = personIdPlusPlus(), observation_period_start_date = "2010-02-06")
add_core(key = "4200000000304", age = 20, year = 2010, amonth = 2, aweekend = -9) # 1st of Feb 2010 is a Saturday
expect_observation_period(person_id = personIdPlusPlus(), observation_period_start_date = "2010-02-01")

declareTest(303, "Observation period end date")
add_core(key = "4200000000305", age = 20, year = 2010, amonth = 2, aweekend = 0, los = 0) # 1st of Feb 2010 is a Monday
expect_observation_period(person_id = personIdPlusPlus(), observation_period_end_date = "2010-02-01")
add_core(key = "4200000000306", age = 20, year = 2010, amonth = 2, aweekend = 0, los = 2) # 1st of Feb 2010 is a Monday
expect_observation_period(person_id = personIdPlusPlus(), observation_period_end_date = "2010-02-03")
add_core(key = "4200000000307", age = 20, year = 2010, amonth = 2, aweekend = 0, los = -9) # 1st of Feb 2010 is a Monday
expect_observation_period(person_id = personIdPlusPlus(), observation_period_end_date = "2010-02-01")

declareTest(304, "Observation period type concept ID")
add_core(key = "4200000000308", age = 20)
...
add_core(key = "4200000000401", age = 20, hospst = "NY", hospstco = "36061")
...
add_core(key = "4200000000501", age = 20, hospst = "NY", hospstco = "36061", hospid = "999")
...
add_core(key = "4200000000603", age = 20, dx1 = "486", dx2 = "4019", dx3 = "25000")
...
add_core(key = "4200000000604", age = 20, dx1 = "V3000", dx2 = NULL, dx3 = NULL, dx4 = NULL, dx5 = NULL, dx6 = NULL, dx7 = NULL, dx8 = NULL, dx9 = NULL, dx10 = NULL, dx11 = NULL, dx12 = NULL, dx13 = NULL, dx14 = NULL, dx15 = NULL, dx16 = NULL, dx17 = NULL, dx18 = NULL, dx19 = NULL, dx20 = NULL, dx21 = NULL, dx22 = NULL, dx23 = NULL, dx24 = NULL, dx25 = NULL)
expect_no_condition_occurrence(person_id = personIdPlusPlus())

declareTest(605, "Condition occurrence start and end date")
add_core(key = "4200000000605", age = 20, dx1 = "486", year = 2010, amonth = 2, aweekend = 0) # 1st of Feb 2010 is a Monday
...
add_core(key = "4200000000606", age = 20, dx1 = "486", dx2 = NULL, dx3 = NULL, dx4 = NULL, dx5 = NULL, dx6 = NULL, dx7 = NULL, dx8 = NULL, dx9 = NULL, dx10 = NULL, dx11 = NULL, dx12 = NULL, dx13 = NULL, dx14 = NULL, dx15 = NULL, dx16 = NULL, dx17 = NULL, dx18 = NULL, dx19 = NULL, dx20 = NULL, dx21 = NULL, dx22 = NULL, dx23 = NULL, dx24 = NULL, dx25 = NULL)
expect_condition_occurrence(person_id = personIdPlusPlus(), condition_type_concept_id = 38000184)

declareTest(602, "Condition occurrence visit occurrence id")
add_core(key = "4200000000607", age = 20, dx1 = "486")
...
add_core(key = "4200000000701", age = 20, died = 1)
...
add_core(key = "4200000000803", age = 20, pr1 = "7359", pr2 = "9904", pr3 = "3722")
...
add_core(key = "4200000000804", age = 20, pr1 = "7359", prday1 = 3, year = 2010, amonth = 2, aweekend = 0, los = 4) # 1st of Feb 2010 is a Monday
...
add_core(key = "4200000000807", age = 20, dx1 = "V252") 
...
add_core(key = "4200000000808", age = 20, dx1 = "486")
...
add_core(key = "4200000000903", age = 20, dx1 = "25002", year = 2010, amonth = 2, aweekend = 0) # 1st of Feb 2010 is a Monday
expect_measurement(person_id = personIdPlusPlus(), measurement_date = "2010-02-01")

declareTest(904, "Measurement type concept ID")
add_core(key = "4200000000904", age = 20, dx1 = "25002", dx2 = NULL, dx3 = NULL, dx4 = NULL, dx5 = NULL, dx6 = NULL, dx7 = NULL, dx8 = NULL, dx9 = NULL, dx10 = NULL, dx11 = NULL, dx12 = NULL, dx13 = NULL, dx14 = NULL, dx15 = NULL, dx16 = NULL, dx17 = NULL, dx18 = NULL, dx19 = NULL, dx20 = NULL, dx21 = NULL, dx22 = NULL, dx23 = NULL, dx24 = NULL, dx25 = NULL)
...
add_core(key = "4200000000905", age = 20, dx1 = "25002")
...
add_core(key = "4200000001003", age = 20, dx1 = "V3000", year = 2010, amonth = 2, aweekend = 0) # 1st of Feb 2010 is a Monday
expect_observation(person_id = personIdPlusPlus(), observation_date = "2010-02-01")

declareTest(1004, "Observation type concept ID")
add_core(key = "4200000001004", age = 20, dx1 = "V3000", dx2 = NULL, dx3 = NULL, dx4 = NULL, dx5 = NULL, dx6 = NULL, dx7 = NULL, dx8 = NULL, dx9 = NULL, dx10 = NULL, dx11 = NULL, dx12 = NULL, dx13 = NULL, dx14 = NULL, dx15 = NULL, dx16 = NULL, dx17 = NULL, dx18 = NULL, dx19 = NULL, dx20 = NULL, dx21 = NULL, dx22 = NULL, dx23 = NULL, dx24 = NULL, dx25 = NULL)
...
add_core(key = "4200000001005", age = 20, dx1 = "V3000")
...
querySql(connection, "SELECT person_id FROM person WHERE person_source_value = '4200000000904'")
