...
CREATE TABLE PROCEDURE_COST (
	PROCEDURE_COST_ID INT NOT NULL,
...
ALTER TABLE cohort
   ALTER COLUMN cohort_id SET DEFAULT nextval('cohort_id_seq');

ALTER SEQUENCE cohort_id_seq OWNED BY cohort.cohort_id;
